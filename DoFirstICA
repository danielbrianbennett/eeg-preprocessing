function [ALLEEG EEG CURRENTSET] = DoFirstICA(params)
...
for r = 1:params.runsToDo
        ...
        for i = 1:params.nEpochDivisions
            ...
            if ~params.isMerged
                ...
                savename = [params.sbj '_r' num2str(r) '_' params.epochNames{i} '_ica1.set'];
            else filename = [params.sbj  '_' params.epochNames{i} params.saveSuffix];
                savename = [params.sbj  '_' params.epochNames{i} '_ica1.set'];
            end
